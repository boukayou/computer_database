            ...
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form action="EditComputer" method="POST">
                        <input type="hidden" value="${computerToEdit.id}" id="id" name="idComputer"/> <!-- TODO: Change this value with the computer id -->
                        <fieldset>
                            <div class="form-group">
                                <label for="computerName">computer Name</label>
                                <input type="text" class="form-control" id="computerName" name="computerName" value="${computerToEdit.name}"  placeholder="Computer name">
                            </div>
                            <div class="form-group">
